    ...
    >
      <ul className="space-y-4">
        {items.map(item => (
          <div key={item.id}>
            ...
            {item.children ? (
              <div className="mb-2">
                <h3 className="px-3 text-xs font-semibold text-slate-600 uppercase tracking-wider mb-2">
                  {item.title}
                </h3>
      ...
      <div className="mt-8 pt-8 border-t border-slate-200 px-3">
        <a
          ...
          className="block mb-4 text-sm font-medium text-primary-600 hover:text-primary-700 hover:underline"
        >
          ← Back to holmdigital.se
        </a>
        ...
        <div className="mb-4 p-3 bg-slate-50 rounded-md border border-slate-200">
          ...
          <a href="https://holmdigital.se/tillganglighetsanalys" target="_blank" className="text-xs text-slate-600 hover:text-primary-600 block">
