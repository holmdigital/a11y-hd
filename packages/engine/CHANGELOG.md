...
- 66a7f8c: Escapa scan-URL och axe-härledd text i den genererade HTML-rapporten.
...
- f73caa5: Intern #63 och #66 — lagraden upprepar inte längre namnet, och 14 länder får rättad lagdata i utlåtandet.
...
- Updated dependencies [f73caa5]
- Updated dependencies [f73caa5]
  - @holmdigital/components@4.0.2
  - @holmdigital/standards@4.1.1

## 3.3.9

### Patch Changes

- c96eb15: Intern #63 — tillsynsmyndigheten i utlåtandet får landets eget namn.
...
- Updated dependencies [c96eb15]
  - @holmdigital/standards@4.1.0

## 3.3.8

### Patch Changes

- 78db575: Intern #65 fynd 5 och 6 — tre mallar hårdkodade lagnamn och gick förbi lagvalet.
...
- Updated dependencies [78db575]
  - @holmdigital/standards@4.0.1

## 3.3.7

### Patch Changes

- 46a8ed8: Intern #63 — privat sektor i Frankrike, Danmark och Spanien får ett namngivet lagrum.
...
- Updated dependencies [46a8ed8]
- Updated dependencies [46a8ed8]
  - @holmdigital/components@4.0.1
  - @holmdigital/standards@4.0.0

## 3.3.6

### Patch Changes

- 7a6dfb7: Intern #64 — lagvalet går nu på land + scope + inForce, aldrig på `euFramework`, och en lag som inte trätt i kraft renderas aldrig som gällande rätt.
...
- Updated dependencies [7a6dfb7]
  - @holmdigital/standards@3.1.0

## 3.3.5

### Patch Changes

- d7753d4: Intern #25 — Puppeteer 25.4.0 → 25.6.0, verifierat neutral före bump.
...
- 1e5d68b: Intern #56 — lagraden bygger nu på Junos tre-grensmodell, och needs-review-texten slutar påstå att posterna inte är hinder.
...
- 69a67c9: Intern #56 — klarspråksrapportens lagrad påstod DOS-lagen även för privata kunder.
...
- bc8bcf9: Intern #43 fynd 1 (Mejas exit-kod-fynd) — en INCONCLUSIVE-scan ger nu non-zero exit **oavsett flaggor**.
...
- Updated dependencies [bc8bcf9]
  - @holmdigital/standards@3.0.6

## 3.3.1

### Patch Changes

- 62e0dfe: Intern #39 — EN-9.x-taggen som `en301549Criteria`-fallback för ärligt omappade fynd.
...
- b1fb148: Intern #43 fynd 1 (omarbetning) — en interstitial-/vänta-/challenge-scan ger nu ett ärligt INCONCLUSIVE-resultat i stället för en vilseledande score.
...
- 66e5f9b: Intern #43 — två robusthetsfynd i motorn.
