  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
      <div className="lg:grid lg:grid-cols-12 lg:gap-8">
        ...
        {/* Main Content Column */}
        <article className="lg:col-span-9 xl:col-span-8" id="article-content" tabIndex={-1}>

          {/* Breadcrumbs */}
          <nav aria-label="Breadcrumb" className="mb-6 flex items-center text-sm text-slate-700">
